      ...
      <div className="flex flex-col md:flex-row gap-8 items-center">
        <div className="md:w-1/2">
          <div className="bg-background-secondary dark:bg-background p-4 rounded-xl relative overflow-hidden border border-border">
            ...
            <div className="absolute top-5 left-5 w-7 h-8 bg-primary/20 rounded animate-pulse [animation-delay:1.5s]">
              <div className="w-full h-2 bg-primary/40 rounded-t"></div>
              <div className="w-5/6 h-1 bg-primary/30 mt-1 mx-auto"></div>
              <div className="w-4/6 h-1 bg-primary/30 mt-1 mx-auto"></div>
              <div className="w-3/6 h-1 bg-primary/30 mt-1 mx-auto"></div>
            </div>
            <div className="absolute bottom-5 right-4 w-8 h-6 bg-primary/15 rounded animate-bounce [animation-delay:0.8s] [animation-duration:3.2s]">
            ...
            <div className="absolute top-2/3 left-6 w-6 h-6 bg-primary/25 rounded animate-ping [animation-delay:2.5s]">
              <div className="absolute inset-1 border border-primary/30 rounded"></div>
              <div className="absolute top-2 left-2 w-2 h-2 bg-primary/40 rounded"></div>
            </div>
            <OptimizedImage
